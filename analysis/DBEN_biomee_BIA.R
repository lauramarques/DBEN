...
## Outputs ####
### P0 ####
write.csv(out_sc1$data[[1]]$output_annual_tile, paste0(here::here(), "/data/outputs_mod/412ppm/BiomeE_P0_BIA_aCO2_annual_tile.csv"))
write.csv(out_sc1$data[[1]]$output_annual_cohorts, paste0(here::here(), "/data/outputs_mod/412ppm/BiomeE_P0_BIA_aCO2_annual_cohorts.csv"))

### PS-1 (0.01 or nfrequency=100) ####
write.csv(out_sc1$data[[1]]$output_annual_tile, paste0(here::here(), "/data/outputs_mod/412ppm/BiomeE_PS1_BIA_aCO2_annual_tile.csv"))
write.csv(out_sc1$data[[1]]$output_annual_cohorts, paste0(here::here(), "/data/outputs_mod/412ppm/BiomeE_PS1_BIA_aCO2_annual_cohorts.csv"))

### PS-2 (0.02 or nfrequency=75) ####
write.csv(out_sc1$data[[1]]$output_annual_tile, paste0(here::here(), "/data/outputs_mod/412ppm/BiomeE_PS2_BIA_aCO2_annual_tile.csv"))
write.csv(out_sc1$data[[1]]$output_annual_cohorts, paste0(here::here(), "/data/outputs_mod/412ppm/BiomeE_PS2_BIA_aCO2_annual_cohorts.csv"))

### PS-3 (0.04 or nfrequency=50) ####
write.csv(out_sc1$data[[1]]$output_annual_tile, paste0(here::here(), "/data/outputs_mod/412ppm/BiomeE_PS3_BIA_aCO2_annual_tile.csv"))
write.csv(out_sc1$data[[1]]$output_annual_cohorts, paste0(here::here(), "/data/outputs_mod/412ppm/BiomeE_PS3_BIA_aCO2_annual_cohorts.csv"))

### PS-4 (0.08 or nfrequency=25) ####
write.csv(out_sc1$data[[1]]$output_annual_tile, paste0(here::here(), "/data/outputs_mod/412ppm/BiomeE_PS4_BIA_aCO2_annual_tile.csv"))
write.csv(out_sc1$data[[1]]$output_annual_cohorts, paste0(here::here(), "/data/outputs_mod/412ppm/BiomeE_PS4_BIA_aCO2_annual_cohorts.csv"))

### PS-5 (0.20 or nfrequency=15) ####
write.csv(out_sc1$data[[1]]$output_annual_tile, paste0(here::here(), "/data/outputs_mod/412ppm/BiomeE_PS5_BIA_aCO2_annual_tile.csv"))
write.csv(out_sc1$data[[1]]$output_annual_cohorts, paste0(here::here(), "/data/outputs_mod/412ppm/BiomeE_PS5_BIA_aCO2_annual_cohorts.csv"))

### PS-6 (0.40 or nfrequency=10) ####
write.csv(out_sc1$data[[1]]$output_annual_tile, paste0(here::here(), "/data/outputs_mod/412ppm/BiomeE_PS6_BIA_aCO2_annual_tile.csv"))
write.csv(out_sc1$data[[1]]$output_annual_cohorts, paste0(here::here(), "/data/outputs_mod/412ppm/BiomeE_PS6_BIA_aCO2_annual_cohorts.csv"))
...
### P0 ####
write.csv(out_sc1$data[[1]]$output_annual_tile, paste0(here::here(), "/data/outputs_mod/562ppm/BiomeE_P0_BIA_eCO2_annual_tile.csv"))
write.csv(out_sc1$data[[1]]$output_annual_cohorts, paste0(here::here(), "/data/outputs_mod/562ppm/BiomeE_P0_BIA_eCO2_annual_cohorts.csv"))

### PS-1 (0.01 or nfrequency=100) ####
write.csv(out_sc1$data[[1]]$output_annual_tile, paste0(here::here(), "/data/outputs_mod/562ppm/BiomeE_PS1_BIA_eCO2_annual_tile.csv"))
write.csv(out_sc1$data[[1]]$output_annual_cohorts, paste0(here::here(), "/data/outputs_mod/562ppm/BiomeE_PS1_BIA_eCO2_annual_cohorts.csv"))

### PS-2 (0.02 or nfrequency=75) ####
write.csv(out_sc1$data[[1]]$output_annual_tile, paste0(here::here(), "/data/outputs_mod/562ppm/BiomeE_PS2_BIA_eCO2_annual_tile.csv"))
write.csv(out_sc1$data[[1]]$output_annual_cohorts, paste0(here::here(), "/data/outputs_mod/562ppm/BiomeE_PS2_BIA_eCO2_annual_cohorts.csv"))

### PS-3 (0.04 or nfrequency=50) ####
write.csv(out_sc1$data[[1]]$output_annual_tile, paste0(here::here(), "/data/outputs_mod/562ppm/BiomeE_PS3_BIA_eCO2_annual_tile.csv"))
write.csv(out_sc1$data[[1]]$output_annual_cohorts, paste0(here::here(), "/data/outputs_mod/562ppm/BiomeE_PS3_BIA_eCO2_annual_cohorts.csv"))

### PS-4 (0.08 or nfrequency=25) ####
write.csv(out_sc1$data[[1]]$output_annual_tile, paste0(here::here(), "/data/outputs_mod/562ppm/BiomeE_PS4_BIA_eCO2_annual_tile.csv"))
write.csv(out_sc1$data[[1]]$output_annual_cohorts, paste0(here::here(), "/data/outputs_mod/562ppm/BiomeE_PS4_BIA_eCO2_annual_cohorts.csv"))

### PS-5 (0.20 or nfrequency=15) ####
write.csv(out_sc1$data[[1]]$output_annual_tile, paste0(here::here(), "/data/outputs_mod/562ppm/BiomeE_PS5_BIA_eCO2_annual_tile.csv"))
write.csv(out_sc1$data[[1]]$output_annual_cohorts, paste0(here::here(), "/data/outputs_mod/562ppm/BiomeE_PS5_BIA_eCO2_annual_cohorts.csv"))

### PS-6 (0.40 or nfrequency=10) ####
write.csv(out_sc1$data[[1]]$output_annual_tile, paste0(here::here(), "/data/outputs_mod/562ppm/BiomeE_PS6_BIA_eCO2_annual_tile.csv"))
write.csv(out_sc1$data[[1]]$output_annual_cohorts, paste0(here::here(), "/data/outputs_mod/562ppm/BiomeE_PS6_BIA_eCO2_annual_cohorts.csv"))
