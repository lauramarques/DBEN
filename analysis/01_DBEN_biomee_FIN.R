...
biomee_annual_tile <- read.csv("/home/laura/DBEN/data/outputs_mod/412ppm/BiomeE_P0_FIN_aCO2_annual_tile.csv")
biomee_annual_cohorts <- read.csv("/home/laura/DBEN/data/outputs_mod/412ppm/BiomeE_P0_FIN_aCO2_annual_cohorts.csv")
...
### P0 ----
write.csv(out$data[[1]]$output_annual_tile, "/home/laura/DBEN/data/outputs_mod/412ppm/BiomeE_P0_FIN_aCO2_annual_tile.csv")
write.csv(out$data[[1]]$output_annual_cohorts, "/home/laura/DBEN/data/outputs_mod/412ppm/BiomeE_P0_FIN_aCO2_annual_cohorts.csv")

### PS-1 (0.01 or nfrequency=100) ----
write.csv(out$data[[1]]$output_annual_tile, "/home/laura/DBEN/data/outputs_mod/412ppm/BiomeE_PS1_FIN_aCO2_annual_tile.csv")
write.csv(out$data[[1]]$output_annual_cohorts, "/home/laura/DBEN/data/outputs_mod/412ppm/BiomeE_PS1_FIN_aCO2_annual_cohorts.csv")

### PS-2 (0.02 or nfrequency=50) ----
write.csv(out$data[[1]]$output_annual_tile, "/home/laura/DBEN/data/outputs_mod/412ppm/BiomeE_PS2_FIN_aCO2_annual_tile.csv")
write.csv(out$data[[1]]$output_annual_cohorts, "/home/laura/DBEN/data/outputs_mod/412ppm/BiomeE_PS2_FIN_aCO2_annual_cohorts.csv")

### PS-3 (0.04 or nfrequency=25) ----
write.csv(out$data[[1]]$output_annual_tile, "/home/laura/DBEN/data/outputs_mod/412ppm/BiomeE_PS3_FIN_aCO2_annual_tile.csv")
write.csv(out$data[[1]]$output_annual_cohorts, "/home/laura/DBEN/data/outputs_mod/412ppm/BiomeE_PS3_FIN_aCO2_annual_cohorts.csv")

### PS-4 (0.08 or nfrequency=12.5) ----
write.csv(out$data[[1]]$output_annual_tile, "/home/laura/DBEN/data/outputs_mod/412ppm/BiomeE_PS4_FIN_aCO2_annual_tile.csv")
write.csv(out$data[[1]]$output_annual_cohorts, "/home/laura/DBEN/data/outputs_mod/412ppm/BiomeE_PS4_FIN_aCO2_annual_cohorts.csv")

### PS-5 (0.20 or nfrequency=5) ----
write.csv(out$data[[1]]$output_annual_tile, "/home/laura/DBEN/data/outputs_mod/412ppm/BiomeE_PS5_FIN_aCO2_annual_tile.csv")
write.csv(out$data[[1]]$output_annual_cohorts, "/home/laura/DBEN/data/outputs_mod/412ppm/BiomeE_PS5_FIN_aCO2_annual_cohorts.csv")

### PS-6 (0.40 or nfrequency=2.5) ----
write.csv(out$data[[1]]$output_annual_tile, "/home/laura/DBEN/data/outputs_mod/412ppm/BiomeE_PS6_FIN_aCO2_annual_tile.csv")
write.csv(out$data[[1]]$output_annual_cohorts, "/home/laura/DBEN/data/outputs_mod/412ppm/BiomeE_PS6_FIN_aCO2_annual_cohorts.csv")

# Save Outputs 562 ppm ----
### P0 ----
write.csv(out$data[[1]]$output_annual_tile, "/home/laura/DBEN/data/outputs_mod/562ppm/BiomeE_P0_FIN_eCO2_annual_tile.csv")
write.csv(out$data[[1]]$output_annual_cohorts, "/home/laura/DBEN/data/outputs_mod/562ppm/BiomeE_P0_FIN_eCO2_annual_cohorts.csv")

### PS-1 (0.01 or nfrequency=100) ----
write.csv(out$data[[1]]$output_annual_tile, "/home/laura/DBEN/data/outputs_mod/562ppm/BiomeE_PS1_FIN_eCO2_annual_tile.csv")
write.csv(out$data[[1]]$output_annual_cohorts, "/home/laura/DBEN/data/outputs_mod/562ppm/BiomeE_PS1_FIN_eCO2_annual_cohorts.csv")

### PS-2 (0.02 or nfrequency=50) ----
write.csv(out$data[[1]]$output_annual_tile, "/home/laura/DBEN/data/outputs_mod/562ppm/BiomeE_PS2_FIN_eCO2_annual_tile.csv")
write.csv(out$data[[1]]$output_annual_cohorts, "/home/laura/DBEN/data/outputs_mod/562ppm/BiomeE_PS2_FIN_eCO2_annual_cohorts.csv")

### PS-3 (0.04 or nfrequency=25) ----
write.csv(out$data[[1]]$output_annual_tile, "/home/laura/DBEN/data/outputs_mod/562ppm/BiomeE_PS3_FIN_eCO2_annual_tile.csv")
write.csv(out$data[[1]]$output_annual_cohorts, "/home/laura/DBEN/data/outputs_mod/562ppm/BiomeE_PS3_FIN_eCO2_annual_cohorts.csv")

### PS-4 (0.08 or nfrequency=12.5) ----
write.csv(out$data[[1]]$output_annual_tile, "/home/laura/DBEN/data/outputs_mod/562ppm/BiomeE_PS4_FIN_eCO2_annual_tile.csv")
write.csv(out$data[[1]]$output_annual_cohorts, "/home/laura/DBEN/data/outputs_mod/562ppm/BiomeE_PS4_FIN_eCO2_annual_cohorts.csv")

### PS-5 (0.20 or nfrequency=5) ----
write.csv(out$data[[1]]$output_annual_tile, "/home/laura/DBEN/data/outputs_mod/562ppm/BiomeE_PS5_FIN_eCO2_annual_tile.csv")
write.csv(out$data[[1]]$output_annual_cohorts, "/home/laura/DBEN/data/outputs_mod/562ppm/BiomeE_PS5_FIN_eCO2_annual_cohorts.csv")

### PS-6 (0.40 or nfrequency=2.5) ----
write.csv(out$data[[1]]$output_annual_tile, "/home/laura/DBEN/data/outputs_mod/562ppm/BiomeE_PS6_FIN_eCO2_annual_tile.csv")
write.csv(out$data[[1]]$output_annual_cohorts, "/home/laura/DBEN/data/outputs_mod/562ppm/BiomeE_PS6_FIN_eCO2_annual_cohorts.csv")
